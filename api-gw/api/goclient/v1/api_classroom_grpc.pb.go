...
const (
	ClassroomService_CreateClassroom_FullMethodName      = "/api.classroom.v1.ClassroomService/CreateClassroom"
	ClassroomService_GetClassroom_FullMethodName         = "/api.classroom.v1.ClassroomService/GetClassroom"
	ClassroomService_UpdateClassroom_FullMethodName      = "/api.classroom.v1.ClassroomService/UpdateClassroom"
	ClassroomService_DeleteClassroom_FullMethodName      = "/api.classroom.v1.ClassroomService/DeleteClassroom"
	ClassroomService_GetClassrooms_FullMethodName        = "/api.classroom.v1.ClassroomService/GetClassrooms"
	ClassroomService_CheckClassroomExists_FullMethodName = "/api.classroom.v1.ClassroomService/CheckClassroomExists"
	ClassroomService_GetLecturerClassroom_FullMethodName = "/api.classroom.v1.ClassroomService/GetLecturerClassroom"
)
...
var ClassroomService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.classroom.v1.ClassroomService",
