...
func (m *CommonAttachmentResponse) validate(all bool) error {
	...
	if m.GetStatusCode() < 1 {
		err := CommonAttachmentResponseValidationError{
			field:  "StatusCode",
...
// Validate checks the field values on SubmissionAttachmentResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SubmissionAttachmentResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SubmissionAttachmentResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SubmissionAttachmentResponseMultiError, or nil if none found.
func (m *SubmissionAttachmentResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *SubmissionAttachmentResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SubmissionAttachmentResponseValidationError{
		...
		if err := v.Validate(); err != nil {
			return SubmissionAttachmentResponseValidationError{
				field:  "SubmissionDate",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return SubmissionAttachmentResponseMultiError(errors)
	}

	return nil
}

// SubmissionAttachmentResponseMultiError is an error wrapping multiple
// validation errors returned by SubmissionAttachmentResponse.ValidateAll() if
// the designated constraints aren't met.
type SubmissionAttachmentResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SubmissionAttachmentResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SubmissionAttachmentResponseMultiError) AllErrors() []error { return m }

// SubmissionAttachmentResponseValidationError is the validation error returned
// by SubmissionAttachmentResponse.Validate if the designated constraints
// aren't met.
type SubmissionAttachmentResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SubmissionAttachmentResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SubmissionAttachmentResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SubmissionAttachmentResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SubmissionAttachmentResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SubmissionAttachmentResponseValidationError) ErrorName() string {
	return "SubmissionAttachmentResponseValidationError"
}

// Error satisfies the builtin error interface
func (e SubmissionAttachmentResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSubmissionAttachmentResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SubmissionAttachmentResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SubmissionAttachmentResponseValidationError{}

// Validate checks the field values on AuthorAttachmentResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AuthorAttachmentResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AuthorAttachmentResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AuthorAttachmentResponseMultiError, or nil if none found.
func (m *AuthorAttachmentResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *AuthorAttachmentResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AuthorAttachmentResponseMultiError(errors)
	}

	return nil
}

// AuthorAttachmentResponseMultiError is an error wrapping multiple validation
// errors returned by AuthorAttachmentResponse.ValidateAll() if the designated
// constraints aren't met.
type AuthorAttachmentResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AuthorAttachmentResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AuthorAttachmentResponseMultiError) AllErrors() []error { return m }

// AuthorAttachmentResponseValidationError is the validation error returned by
// AuthorAttachmentResponse.Validate if the designated constraints aren't met.
type AuthorAttachmentResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AuthorAttachmentResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AuthorAttachmentResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AuthorAttachmentResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AuthorAttachmentResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AuthorAttachmentResponseValidationError) ErrorName() string {
	return "AuthorAttachmentResponseValidationError"
}

// Error satisfies the builtin error interface
func (e AuthorAttachmentResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAuthorAttachmentResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AuthorAttachmentResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AuthorAttachmentResponseValidationError{}
...
func (m *CreateAttachmentRequest) validate(all bool) error {
	...
	if m.GetAttachment() == nil {
		err := CreateAttachmentRequestValidationError{
			field:  "Attachment",
...
func (m *CreateAttachmentResponse) validate(all bool) error {
	...
	if m.GetResponse() == nil {
		err := CreateAttachmentResponseValidationError{
			field:  "Response",
			reason: "value is required",
		}
		if !all {
...
func (m *GetAttachmentRequest) validate(all bool) error {
	...
	if m.GetId() < 1 {
		err := GetAttachmentRequestValidationError{
			field:  "Id",
			reason: "value must be greater than or equal to 1",
		}
		if !all {
...
func (m *CheckAttachmentExistsRequest) validate(all bool) error {
	...
	if m.GetAttachmentID() < 1 {
		err := CheckAttachmentExistsRequestValidationError{
			field:  "AttachmentID",
			reason: "value must be greater than or equal to 1",
		}
		if !all {
...
func (m *UpdateAttachmentRequest) validate(all bool) error {
	...
	if m.GetId() < 1 {
		err := UpdateAttachmentRequestValidationError{
			field:  "Id",
			reason: "value must be greater than or equal to 1",
		}
		if !all {
...
func (m *UpdateAttachmentResponse) validate(all bool) error {
	...
	if m.GetResponse() == nil {
		err := UpdateAttachmentResponseValidationError{
			field:  "Response",
			reason: "value is required",
		}
		if !all {
...
func (m *DeleteAttachmentRequest) validate(all bool) error {
	...
	if m.GetId() < 1 {
		err := DeleteAttachmentRequestValidationError{
			field:  "Id",
			reason: "value must be greater than or equal to 1",
		}
		if !all {
...
func (m *DeleteAttachmentResponse) validate(all bool) error {
	...
	if m.GetResponse() == nil {
		err := DeleteAttachmentResponseValidationError{
			field:  "Response",
			reason: "value is required",
		}
		if !all {
