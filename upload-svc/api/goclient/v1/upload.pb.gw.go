...
func request_UploadService_CreateExercise_0(ctx context.Context, marshaler runtime.Marshaler, client UploadServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_UploadService_CreateExercise_0(ctx context.Context, marshaler runtime.Marshaler, server UploadServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateExerciseRequest
	var metadata runtime.ServerMetadata
...
func RegisterUploadServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UploadServiceServer) error {
	...
	mux.Handle("POST", pattern_UploadService_CreateExercise_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/upload.v1.UploadService/CreateExercise", runtime.WithHTTPPathPattern("/upload.v1.UploadService/CreateExercise"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UploadService_CreateExercise_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_UploadService_CreateExercise_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUploadServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UploadServiceClient) error {
	...
	mux.Handle("POST", pattern_UploadService_CreateExercise_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/upload.v1.UploadService/CreateExercise", runtime.WithHTTPPathPattern("/upload.v1.UploadService/CreateExercise"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UploadService_CreateExercise_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_UploadService_CreateExercise_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"upload.v1.UploadService", "CreateExercise"}, ""))
)

var (
	forward_UploadService_CreateExercise_0 = runtime.ForwardResponseMessage
)
