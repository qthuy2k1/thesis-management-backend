...
func (m *CreateAttachmentResponse) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetAttachmentRes()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateAttachmentResponseValidationError{
					field:  "AttachmentRes",
	...
	} else if v, ok := interface{}(m.GetAttachmentRes()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return CreateAttachmentResponseValidationError{
				field:  "AttachmentRes",
				reason: "embedded message failed validation",
...
// Validate checks the field values on GetAttachmentsOfSubmissionRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *GetAttachmentsOfSubmissionRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetAttachmentsOfSubmissionRequest
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GetAttachmentsOfSubmissionRequestMultiError, or nil if none found.
func (m *GetAttachmentsOfSubmissionRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetAttachmentsOfSubmissionRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetAttachmentsOfSubmissionRequestMultiError(errors)
	}

	return nil
}

// GetAttachmentsOfSubmissionRequestMultiError is an error wrapping multiple
// validation errors returned by
// GetAttachmentsOfSubmissionRequest.ValidateAll() if the designated
// constraints aren't met.
type GetAttachmentsOfSubmissionRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetAttachmentsOfSubmissionRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetAttachmentsOfSubmissionRequestMultiError) AllErrors() []error { return m }

// GetAttachmentsOfSubmissionRequestValidationError is the validation error
// returned by GetAttachmentsOfSubmissionRequest.Validate if the designated
// constraints aren't met.
type GetAttachmentsOfSubmissionRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetAttachmentsOfSubmissionRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetAttachmentsOfSubmissionRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetAttachmentsOfSubmissionRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetAttachmentsOfSubmissionRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetAttachmentsOfSubmissionRequestValidationError) ErrorName() string {
	return "GetAttachmentsOfSubmissionRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetAttachmentsOfSubmissionRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetAttachmentsOfSubmissionRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetAttachmentsOfSubmissionRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetAttachmentsOfSubmissionRequestValidationError{}

// Validate checks the field values on GetAttachmentsOfSubmissionResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *GetAttachmentsOfSubmissionResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetAttachmentsOfSubmissionResponse
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// GetAttachmentsOfSubmissionResponseMultiError, or nil if none found.
func (m *GetAttachmentsOfSubmissionResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetAttachmentsOfSubmissionResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetAttachmentsOfSubmissionResponseValidationError{
					field:  "Response",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetAttachmentsOfSubmissionResponseValidationError{
				field:  "Response",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetAttachmentsOfSubmissionResponseMultiError(errors)
	}

	return nil
}

// GetAttachmentsOfSubmissionResponseMultiError is an error wrapping multiple
// validation errors returned by
// GetAttachmentsOfSubmissionResponse.ValidateAll() if the designated
// constraints aren't met.
type GetAttachmentsOfSubmissionResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetAttachmentsOfSubmissionResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetAttachmentsOfSubmissionResponseMultiError) AllErrors() []error { return m }

// GetAttachmentsOfSubmissionResponseValidationError is the validation error
// returned by GetAttachmentsOfSubmissionResponse.Validate if the designated
// constraints aren't met.
type GetAttachmentsOfSubmissionResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetAttachmentsOfSubmissionResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetAttachmentsOfSubmissionResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetAttachmentsOfSubmissionResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetAttachmentsOfSubmissionResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetAttachmentsOfSubmissionResponseValidationError) ErrorName() string {
	return "GetAttachmentsOfSubmissionResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetAttachmentsOfSubmissionResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetAttachmentsOfSubmissionResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetAttachmentsOfSubmissionResponseValidationError{}
