...
type GetTopicFromUserRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTopicFromUserRequest) Reset() {
	*x = GetTopicFromUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_topic_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTopicFromUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTopicFromUserRequest) ProtoMessage() {}

func (x *GetTopicFromUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_topic_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTopicFromUserRequest.ProtoReflect.Descriptor instead.
func (*GetTopicFromUserRequest) Descriptor() ([]byte, []int) {
	return file_topic_proto_rawDescGZIP(), []int{17}
}

func (x *GetTopicFromUserRequest) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
type GetTopicFromUserResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTopicFromUserResponse) Reset() {
	*x = GetTopicFromUserResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_topic_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTopicFromUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTopicFromUserResponse) ProtoMessage() {}

func (x *GetTopicFromUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_topic_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTopicFromUserResponse.ProtoReflect.Descriptor instead.
func (*GetTopicFromUserResponse) Descriptor() ([]byte, []int) {
	return file_topic_proto_rawDescGZIP(), []int{18}
}

func (x *GetTopicFromUserResponse) GetResponse() *CommonTopicResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *GetTopicFromUserResponse) GetTopic() *TopicResponse {
	if x != nil {
		return x.Topic
	}
	return nil
...
var file_topic_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_topic_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_topic_proto_goTypes = []interface{}{
	...
	(*GetTopicFromUserRequest)(nil),        // 17: topic.v1.GetTopicFromUserRequest
	(*GetTopicFromUserResponse)(nil),       // 18: topic.v1.GetTopicFromUserResponse
}
var file_topic_proto_depIdxs = []int32{
	...
	0,  // 11: topic.v1.GetTopicFromUserResponse.response:type_name -> topic.v1.CommonTopicResponse
	2,  // 12: topic.v1.GetTopicFromUserResponse.topic:type_name -> topic.v1.TopicResponse
	3,  // 13: topic.v1.TopicService.CreateTopic:input_type -> topic.v1.CreateTopicRequest
	5,  // 14: topic.v1.TopicService.GetTopic:input_type -> topic.v1.GetTopicRequest
	17, // 15: topic.v1.TopicService.GetTopicFromUser:input_type -> topic.v1.GetTopicFromUserRequest
	9,  // 16: topic.v1.TopicService.UpdateTopic:input_type -> topic.v1.UpdateTopicRequest
	11, // 17: topic.v1.TopicService.DeleteTopic:input_type -> topic.v1.DeleteTopicRequest
	13, // 18: topic.v1.TopicService.GetTopics:input_type -> topic.v1.GetTopicsRequest
	15, // 19: topic.v1.TopicService.GetAllTopicsOfListUser:input_type -> topic.v1.GetAllTopicsOfListUserRequest
	4,  // 20: topic.v1.TopicService.CreateTopic:output_type -> topic.v1.CreateTopicResponse
	6,  // 21: topic.v1.TopicService.GetTopic:output_type -> topic.v1.GetTopicResponse
	18, // 22: topic.v1.TopicService.GetTopicFromUser:output_type -> topic.v1.GetTopicFromUserResponse
	10, // 23: topic.v1.TopicService.UpdateTopic:output_type -> topic.v1.UpdateTopicResponse
	12, // 24: topic.v1.TopicService.DeleteTopic:output_type -> topic.v1.DeleteTopicResponse
	14, // 25: topic.v1.TopicService.GetTopics:output_type -> topic.v1.GetTopicsResponse
	16, // 26: topic.v1.TopicService.GetAllTopicsOfListUser:output_type -> topic.v1.GetAllTopicsOfListUserResponse
...
func file_topic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_topic_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTopicFromUserRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_topic_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTopicFromUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
